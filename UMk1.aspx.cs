...
public partial class UMk1 : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        //con.Open();
        ////com.Parameters.AddWithValue("@first", rezultat);
        ////com.Parameters.AddWithValue("@second", DetailsView1.Rows[1].Cells[1].Text);
        //com.ExecuteNonQuery();
        //con.Close();
